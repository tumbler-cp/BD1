BEGIN;
CREATE TYPE ship_actions as ENUM (
    'находится в полёте'
    );
...
CREATE TABLE ships (
    ...
    action ship_actions,
    action_duration INT,
    action_duration_unit duration_unit
);
...
ALTER TABLE humans ADD CONSTRAINT f_property
...
INSERT INTO ships(name, action, action_duration, action_duration_unit)
VALUES (
        'Корабль',
        'находится в полёте',
        30,
...
INSERT INTO planets(name) VALUES ('Луна'), ('Марс'), ('Земля');
...
INSERT INTO flights (ship_id, destination, property_id)
VALUES (1, 1, 1), (1, 2, 1);
